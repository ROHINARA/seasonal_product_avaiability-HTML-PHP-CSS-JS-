...
$query="select * from slogin_table";
...
<body>
   ...
   <table align="center" border="1px" style="width:1200px; line-height:40px;font-family:serif;background: #B9E3FF">
        <tr>
		  <th colspan="5"><center><h2>Supplier's Information</h2></center></th>
		  </tr>
		  <t>
		   <th> ID </th>
		   <th>  Name </th>
