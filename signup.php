...
<?php
   if(isset($_POST['sub'])){
	   ...
	   $sqlCheck="SELECT * FROM login_table WHERE login_email='$_POST[email]'";
	   ...
	   $userInsert="INSERT login_table SET
	   ...
	   $sqlSelect="SELECT * FROM login_table WHERE id='$lastId'";
...
<body>
	<ul>
		...
		<li><a href="productgallery.php">View Products</a></li>
...
<form action="" method="post" enctype="multipart/form-data">
	<div class="login-box">
		<center><div style="background:rgba(250,250,250,.3);width:220%;height:600px;">
		<center><h1 style="font-family: algerian">Register Here</h1></center>
...
<tr>
<td>Address<td>:</td><td><input type="text" name="address" required><b style="color:red;">*</b></td>
</tr>
<tr>
  <td></td><td></td><td>
