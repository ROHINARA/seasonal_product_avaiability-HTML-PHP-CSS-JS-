...
<body>
	<ul>
		...
		<ul>
	<li><a href="login.php"><span class="glyphicon glyphicon-user"></span>Admin</li>
	<li><a href="signin.php"><span class="glyphicon glyphicon-user"></span>User</li>
		<li><a href="supsignin.php"><span class="glyphicon glyphicon-user"></span>Supplier</li>
</ul>
...
<?php
  ...
  $sqlSelect="SELECT * FROM login_table WHERE login_name='$_POST[name]'and login_password='$_POST[pass]'";
